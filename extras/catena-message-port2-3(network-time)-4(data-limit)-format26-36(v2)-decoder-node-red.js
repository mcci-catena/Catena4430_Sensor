...
Name:   catena-message-port2-3(network-time)-4(data-limit)-format26-36(v2)-decoder-node-red.js
...
if (result === null) {
    ...
    var eMsg = "not port 2/3/4, not fmt 0x26/0x36! port=" + msg.port.toString();
    if ((port === 2) || (port === 3) || (port === 4)) {
